...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.194523 && value <= 0.277372) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.277372 && value <= 0.360222) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.360222 && value <= 0.443071) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.443071 && value <= 0.525921) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.525921 && value <= 0.608770) {
            style = [ new ol.style.Style({
